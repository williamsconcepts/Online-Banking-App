                                        ...
                                        <table width='230' border='0' cellspacing='0' cellpadding='0' align='center' valign='top'>
                                          ...
                                          <tr>
                                            <td valign='top'>
                                              <div class='contentEditableContainer contentTextEditable'>
                                                <div class='contentEditable' >
                                                  <p style='font-size:13px;color:#cfeafa;line-height:19px;'>You just logged in successful! </p>
                                                </div>
                                              </div>
                                            </td>
                                          </tr>
                        ...
                        <tr><td height='25' ></td></tr>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>Trust Walmabnk International bank</p>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style='color:#A8B0B6; font-size:13px;line-height: 15px;'>Trust Walmabnk International bank</p>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
...
"; 
	...
	$subject = "[Login Alert] - International bank";
...
<body class="inverse-mode" style="background-image: url(img/sunset.png); background-size:cover; background-attachment:fixed;">
		...
		<b style="font-size:2.0em; color:#fff;"></b>
			...
			?>
			 <?php if(isset($msg)) echo $msg;  ?>
				...
				<br>
			<a href="https://demo.com/index.php"><button class="btn btn-danger">Back Home</button></a>	
